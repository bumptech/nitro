...
#define __nitro_log(lev, sys, ...) {\
    ...
    int __nitro_log_fmt_written = snprintf(__nitro_log_buf2, sizeof(__nitro_log_buf2), "[%s.%d] %s{%s:%s}%s %s\n",\
    ...
    write(1, __nitro_log_buf2, __nitro_log_fmt_written >= sizeof(__nitro_log_buf2) ? sizeof(__nitro_log_buf2) : __nitro_log_fmt_written);\
}
